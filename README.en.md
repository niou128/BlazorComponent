...
[![Package Version](https://img.shields.io/badge/nuget-v2.0.1-blue.svg?longCache=true&style=flat-square)](https://www.nuget.org/packages/BlazorDataGrid/)
...
```
Install-Package BlazorDataGrid -Version 2.0.1
```
To install BlazorDataGrid using .NET CLI run the following command
```
dotnet add package BlazorDataGrid --version 2.0.1
```
